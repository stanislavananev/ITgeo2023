...
sys.path.append('/Users/stanislavananyev/PycharmProjects/myproject')
...
def fetch_exchange_rates():
    ...
    with open('/Users/stanislavananyev/PycharmProjects/myproject/scripts/labels1.json', 'r') as fp:
...
while 1:
    ...
    time.sleep(600+random.randint(-15, 15))
